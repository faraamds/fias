CREATE OR REPLACE FUNCTION fias_address_house_room_actual(in_aoguid UUID,in_houseguid UUID DEFAULT NULL, in_roomguid UUID DEFAULT NULL)
...
BEGIN
    ...
    var_address := fias_address_formal(in_aoguid);
