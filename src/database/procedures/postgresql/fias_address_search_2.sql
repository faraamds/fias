CREATE OR REPLACE FUNCTION fias_address_search_2(in_q TEXT, in_regioncode VARCHAR(2) DEFAULT NULL, in_limit INT DEFAULT 10)
...
BEGIN
    ...
    RETURN QUERY
          ...
          ORDER BY ts_rank(to_tsvector('russian', fias_address_object_help_search.address), q) DESC
          LIMIT in_limit;
